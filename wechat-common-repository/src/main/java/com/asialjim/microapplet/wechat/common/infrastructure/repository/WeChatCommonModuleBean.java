...
package com.asialjim.microapplet.wechat.common.infrastructure.repository;
...
@MapperScan(basePackageClasses = {
        WeChatAppBaseMapper.class,
        WeChatUserBaseMapper.class
})
public class WeChatCommonModuleBean {
}
