 ...
 *      <a href="http://www.oracle.com/technetwork/java/javase/downloads/jce-7-download-432124.html">JDK7的下载地址</a></li>
 ...
 */
public class WeChatBusinessCrypt {
     ...
     */
    public WeChatBusinessCrypt(String token, String encodingAesKey, String appId) throws AesException {
        if (StringUtils.isBlank(encodingAesKey)) {
            this.aesKey = new byte[0];
        } else if (StringUtils.length(encodingAesKey) != 43) {
    ...
    String decrypt(String text) throws AesException {
        ...
        // appid不相同的情况
        if (!StringUtils.equals(from_appid, appId))
    ...
    public String decryptMsg(String msgSignature, String timeStamp, String nonce, String postData) throws AesException {
        ...
        if (!StringUtils.equals(msgSignature, signature))
