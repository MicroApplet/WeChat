...
public class WeChatOfficialMsgCrypt {
     ...
     * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
     */
    public String decryptMsg(String msgSignature, String timeStamp, String nonce, String postData, AtomicBoolean enableCipher)
            throws AesException {
        ...
        String encrypted = encrypt[0];
        enableCipher.set(StringUtils.equals(encrypted,"true"));
    ...
    public String verifyUrl(String msgSignature, String timeStamp, String nonce, String echoStr)
            throws AesException {
        String signature = SHA1.getSHA1(token, timeStamp, nonce);
        System.out.println("SHA1:  " + signature);
        System.out.println("MSG1:  " + msgSignature);
