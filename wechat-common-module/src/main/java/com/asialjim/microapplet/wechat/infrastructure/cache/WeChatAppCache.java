...
package com.asialjim.microapplet.wechat.infrastructure.cache;
 ...
 */
@Configuration
public class WeChatAppCache extends CacheNameAndTTLConfig {

    @Getter
    enum Cache implements CacheNameAndTTL {
        weChatAppCache(WeChatApplicationRepository.WX_APP_CACHE, Duration.ofMinutes(30));
