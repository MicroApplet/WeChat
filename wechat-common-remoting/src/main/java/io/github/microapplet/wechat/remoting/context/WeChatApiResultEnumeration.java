...
public enum WeChatApiResultEnumeration {
    ...
    CODE_0(0, "请求成功"),
    CODE_20001(20001,"系统错误"),
    CODE_200014(200014,"模版 tid 参数错误"),
    ...
    CODE_200013(200013,"此模版已被封禁，无法选用"),
    CODE_200012(200012,"私有模板数已达上限，上限 50 个"),
    CODE_41040(41040,"不符合声明文字原创的要求"),
    CODE_45062(45062,"已接广告，不支持api群发"),
    CODE_45083(45083,"设置的 speed 参数不在0到4的范围内"),
    CODE_45084(45084,"没有设置 speed 参数"),
    CODE_89505(89505,"群发进入管理员确认流程"),
    CODE_89504(89504,"群发仍在审批流程中"),
    CODE_40249(40249,"不支持下发营销/推广类的消息内容"),
    CODE_40250(40250,"下发消息内容不规范（包含空值等），建议检查内容规范性后再下发"),
    CODE_40251(40251,"因历史违规导致平台限制账号调用上限，当前已到达下发上限"),
    CODE_40252(40252,"正在调用的模板下发的部分内容已进入平台审核流程，在审核完成前，相关内容暂时无法下发"),

    CODE_40202(40202,"不正确的action"),
    CODE_40203(40203,"不正确的check_operator"),
    CODE_40201(40201,"不正确的URL，一般是开发者未设置回调URL。"),
    CODE_40002(40002,"不合法的凭证类型"),
    CODE_40013(40013,"不合法的 AppID ，请开发者检查 AppID 的正确性，避免异常字符，注意大小写"),
    CODE_40125(40125,"无效的appsecret，请检查appsecret的正确性"),
    CODE_40164(40164,"将ip添加到ip白名单列表即可"),
    CODE_41002(41002,"缺少 appid 参数"),
    CODE_41004(41004,"缺少 secret 参数"),
    CODE_43002(43002,"需要 POST 请求"),
    CODE_45009(45009,"调用超过天级别频率限制。可调用clear_quota接口恢复调用额度。"),
