...
package com.asialjim.microapplet.wechat.official.infrastructure.repository.cache;
 ...
 */
@Configuration
public class WxMpCache extends CacheNameAndTTLConfig {
    public interface Name {
        String oauthPageById = "tmp:wx:mp:oauth-page:by-id";
        String menuOauthPageById = "tmp:wx:mp:menu-oauth-page:by-id";
    }

    @Getter
    enum Cache implements CacheNameAndTTL {
        menuOauthPageById(Name.menuOauthPageById,Duration.ofDays(7)),
