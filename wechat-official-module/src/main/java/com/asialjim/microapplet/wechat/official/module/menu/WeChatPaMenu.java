 ...
 */
package com.asialjim.microapplet.wechat.official.module.menu;
...
@NoArgsConstructor
@AllArgsConstructor
public class WeChatPaMenu implements Comparable<WeChatPaMenu>, Serializable {
    @Serial
    private static final long serialVersionUID = 7071234541656924693L;
    ...
    public int compareTo(WeChatPaMenu o) {
